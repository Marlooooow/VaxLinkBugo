  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: FutureBuilder<_InventoryOverviewData>(
      ...
      builder: (context, snapshot) {
        ...
        final visible = _filtered(inventory, attentionVaccineIds);
          ...
          child: ListView(
            ...
            children: [
              ...
              if (attentionCount > 0) ...[
                ...
                _AttentionBanner(count: attentionCount),
              ],
        ...
        return Wrap(
          ...
          children: [
            _SummaryCard(
              ...
              label: 'Available',
              color: Colors.green,
              selected: selected == _InventoryFilter.available,
              onTap: () => onSelected(_InventoryFilter.available),
            ),
            _SummaryCard(
              width: width,
              value: '$low',
            ...
            _SummaryCard(
              ...
              label: 'Unavailable',
              color: Colors.red,
              selected: selected == _InventoryFilter.unavailable,
              onTap: () => onSelected(_InventoryFilter.unavailable),
            ),
            _SummaryCard(
              width: width,
              ...
              selected: selected == _InventoryFilter.needsReview,
              onTap: () => onSelected(_InventoryFilter.needsReview),
            ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) => Semantics(
    ...
    child: Material(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: color.withValues(alpha: selected ? 0.75 : 0.18),
