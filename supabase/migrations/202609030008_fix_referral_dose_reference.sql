...
begin
  ...
  foreach target_vaccine_id in array target_vaccine_ids loop
    ...
    insert into public.referral_items (id, referral_code, referral_group_id, vaccine_id, dose_number, status) values (item_id, item_code, group_id, target_vaccine_id, target_dose_number, 'pending');
